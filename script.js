...
//___________________
    ...
    document.getElementById("scoreNameInputDiv").style.visibility="hidden";
    ...
    function makeEvent(canvas, event) {
        ...
        setTimeout(function(){
            ...
            if(checkIfLost()){
                ...
                redrawRankinputField()
                if(Score.score > rankStrings[9][2]){
...
function redrawRankinputField(){
    ...
    dialog.style.left = "25%";
        ...
        document.getElementById("dialogScore").innerHTML = ""+Score.savedScore;
